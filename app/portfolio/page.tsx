...
const samsungTrainingAssetOrder = [
  ...
  "Training/Samsung:Premium Retail Services/S22 Field Training/IMG_20220420_142642_636.jpg",
  ...
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220519_141614.jpg",
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220507_115827.jpg",
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220427_131948.jpg",
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220416_130036.jpg",
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220416_120048.jpg",
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220413_104855.jpg",
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220407_152608.jpg",
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220408_155057.jpg",
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220423_110108.jpg",
  ...
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220330_122200.jpg",
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220330_123547.jpg",
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220330_132230.jpg",
  "Training/Samsung:Premium Retail Services/S22 Field Training/20220414_130423.jpg",
...
export default function PortfolioPage() {
  return <main id="main-content"><SiteHeader />
    <section className="page-shell py-16 md:py-28"><div className="translate-y-4 md:translate-y-6"><p className="eyebrow">Portfolio</p><h1 className="display mt-6 max-w-5xl text-5xl font-semibold md:text-8xl">Leadership, Built Through Execution.</h1><p className="mt-9 max-w-3xl text-xl leading-8 text-[#6e6e73]">A portfolio of field leadership, retail execution, and customer engagement built across nationally recognized brands—showcasing how teams were developed, customers were engaged, and results were delivered.</p>
      <nav aria-label="Portfolio sections" className="mt-12 flex flex-wrap gap-x-6 gap-y-3 border-t border-[#d2d2d7] pt-5 text-lg leading-5 font-semibold text-[#424245]">
