...
export default function PortfolioPage() {
  return <main id="main-content"><SiteHeader />
    ...
    <section id="customer-engagement-brand-advocacy" className="scroll-mt-28 pt-20 pb-8 md:pt-28 md:pb-12"><div className="page-shell"><p className="eyebrow">02 · Customer Engagement &amp; Brand Advocacy</p><h2 className="display mt-5 max-w-5xl text-4xl font-semibold md:text-7xl">Building Brand Advocacy Through Customer Engagement.</h2><p className="mt-6 max-w-3xl text-lg leading-8 text-[#6e6e73]">Every customer interaction was an opportunity to educate, build trust, and create enthusiasm for the brands I represented—turning product knowledge into meaningful retail experiences.</p></div>
      <PortfolioNarrativeGallery title="Customer Engagement & Brand Advocacy" directories={["Customer Interactions:Sales/Sennheiser:2020", "Customer Interactions:Sales/Creative Channel Services", "Customer Interactions:Sales/Eero:Marketsource", "Customer Interactions:Sales/Huawei:Mosaic", "Customer Interactions:Sales/Meta:2020 Companies", "Customer Interactions:Sales/Motorola:BDS Connected Solutions", "Customer Interactions:Sales/Samsung:Premium Retail Services", "Misc 2020 Companies Field Pictures/Empire Today Field Pics", "Misc 2020 Companies Field Pictures/Rebath Field Pics"]} excludedAssets={["Customer Interactions:Sales/Creative Channel Services/IMG_2269 copy.JPG", "Customer Interactions:Sales/Creative Channel Services/IMG_2270.JPG", "Customer Interactions:Sales/Eero:Marketsource/IMG_1526.jpeg", "Customer Interactions:Sales/Motorola:BDS Connected Solutions/IMG_20201120_151336643.jpg"]} variant={1} layout="row-grid" collapseFailedAssets loadEagerly collapseUntilLoaded validateVisualMedia />
    </section>

    <section id="performance-recognition" className="scroll-mt-28 bg-white py-20 md:py-28"><div className="page-shell"><p className="eyebrow">03 · Performance &amp; Recognition</p><h2 className="display mt-5 max-w-5xl text-4xl font-semibold md:text-7xl">Recognition Earned Through Results.</h2><p className="mt-6 max-w-3xl text-lg leading-8 text-[#6e6e73]">Across multiple programs, I was recognized as a top performer and team leader—a reflection of the relationships I built and the results I delivered in the field.</p></div>
